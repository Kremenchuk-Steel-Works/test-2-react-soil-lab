    ...
    return (
      <div className={`relative w-full ${className || ''}`} style={style}>
        <textarea
          ...
          className={`peer min-h-[72px] w-full resize-y rounded-md border border-gray-300 bg-gray-50 px-4 pt-5 pb-2 text-base focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 ${className || ''} `}
          placeholder=" "
        />
