...
import type { AddressOperationRequest } from '@/entities/admin-old/address/types/request.dto'
import type { ContactOperationRequest } from '@/entities/admin-old/contact/types/request.dto'
import type { EmployeeProfileOperationRequest } from '@/entities/admin-old/employeeProfile/types/request.dto'
import PeopleForm, { type PeopleFormInitialData } from '@/entities/admin-old/people/forms/form'
...
import type { PersonUpdateRequest } from '@/entities/admin-old/people/types/request.dto'
