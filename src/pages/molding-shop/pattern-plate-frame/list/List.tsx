...
import { patternPlateFrameColumns } from '@/pages/molding-shop/pattern-plate-frame/list/columns'
import { useUrlPagination } from '@/shared/hooks/useUrlPagination'
import AlertMessage, { AlertType } from '@/shared/ui/alert-message/AlertMessage'
import { DataTable } from '@/widgets/data-table'

export default function PatternPlateFrameList() {
  // Состояние из URL
  ...
  return (
    <>
      ...
      {!isLoading && !isError && data && (
        <DataTable
          data={data?.data ?? []}
          columns={patternPlateFrameColumns}
