...
import { moldingSandTypeColumns } from '@/pages/molding-shop/molding-sand-type/list/columns'
import { useUrlPagination } from '@/shared/hooks/useUrlPagination'
import AlertMessage, { AlertType } from '@/shared/ui/alert-message/AlertMessage'
import { DataTable } from '@/widgets/data-table'

export default function MoldingSandTypeList() {
  // Состояние из URL
  ...
  return (
    <>
      ...
      {!isLoading && !isError && data && (
        <DataTable
          data={data?.data ?? []}
          columns={moldingSandTypeColumns}
