...
import { castingTechnologyColumns } from '@/pages/molding-shop/casting-technology/list/columns'
import { useUrlPagination } from '@/shared/hooks/useUrlPagination'
import AlertMessage, { AlertType } from '@/shared/ui/alert-message/AlertMessage'
import { DataTable } from '@/widgets/data-table'

export default function CastingTechnologyList() {
  // Состояние из URL
  ...
  return (
    <>
      ...
      {!isLoading && !isError && data && (
        <DataTable
          data={data?.data ?? []}
          columns={castingTechnologyColumns}
