...
const ExperimentsLayout = lazy(() => import('@/pages/soil-lab/experiments/ui/Layout'))
const ExperimentsList = lazy(() => import('@/pages/soil-lab/experiments/ui/list/List'))
const ExperimentsAdd = lazy(() => import('@/pages/soil-lab/experiments/ui/Add'))
const ExperimentsDetails = lazy(() => import('@/pages/soil-lab/experiments/ui/Details'))
