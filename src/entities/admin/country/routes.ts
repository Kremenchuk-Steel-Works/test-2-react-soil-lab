...
import { Database, CirclePlus, Info, RefreshCcw, Globe } from "lucide-react"
import type { AppRoute } from "../../../app/routes/routes.config"
import AdminCountryLayout from "../../../pages/admin-panel/country/Layout"

const AdminCountryList = lazy(
  () => import("../../../pages/admin-panel/country/list/List")
)
const AdminCountryAdd = lazy(
  () => import("../../../pages/admin-panel/country/Add")
)
const AdminCountryDetails = lazy(
  () => import("../../../pages/admin-panel/country/Details")
)
const AdminCountryUpdate = lazy(
  () => import("../../../pages/admin-panel/country/Update")
)
