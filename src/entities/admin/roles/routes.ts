...
const AdminRolesList = lazy(
  () => import("../../../pages/admin-panel/roles/list/List")
)
const AdminRolesAdd = lazy(() => import("../../../pages/admin-panel/roles/Add"))
const AdminRolesDetails = lazy(
  () => import("../../../pages/admin-panel/roles/Details")
)
const AdminRolesUpdate = lazy(
  () => import("../../../pages/admin-panel/roles/Update")
)
