...
import { Database, CirclePlus, Info, RefreshCcw, Layers } from "lucide-react"
...
const AdminDepartmentsList = lazy(
  () => import("../../../pages/admin-panel/departments/list/List")
)
const AdminDepartmentsAdd = lazy(
  () => import("../../../pages/admin-panel/departments/Add")
)
const AdminDepartmentsDetails = lazy(
  () => import("../../../pages/admin-panel/departments/Details")
)
const AdminDepartmentsUpdate = lazy(
  () => import("../../../pages/admin-panel/departments/Update")
)
