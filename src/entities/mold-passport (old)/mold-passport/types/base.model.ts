import type { ShiftNumber } from '@/entities/mold-passport (old)/mold-passport/types/shiftNumber'
import type { MoldPassportStatus } from '@/entities/mold-passport (old)/mold-passport/types/status'
import type { PassportDataResponse } from '@/entities/mold-passport (old)/passport-data/types/response.dto'
