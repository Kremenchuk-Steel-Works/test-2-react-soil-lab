import type { MixtureSubType } from '@/entities/mold-passport (old)/mixtures/types/subType'
import type { MixtureType } from '@/entities/mold-passport (old)/mixtures/types/type'
