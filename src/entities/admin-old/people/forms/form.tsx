...
import { AddressForm } from '@/entities/admin-old/address/forms/form'
import { ContactForm } from '@/entities/admin-old/contact/forms/form'
import { EmployeeProfileForm } from '@/entities/admin-old/employeeProfile/forms/form'
...
import { peopleSchema, type PeopleFormFields } from '@/entities/admin-old/people/forms/schema'
