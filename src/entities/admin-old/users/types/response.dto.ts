import type { PermissionResponse } from '@/entities/admin-old/permissions/types/response.dto'
import type { RoleResponse } from '@/entities/admin-old/roles/types/response.dto'
import type { UserBase } from '@/entities/admin-old/users/types/base.model'
