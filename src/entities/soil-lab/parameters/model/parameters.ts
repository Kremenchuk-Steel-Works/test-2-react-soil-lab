...
export const testResultParametersLabels = {
  ...
  tensile_strength: 'Міцність на розрив у висушеному стані',
  tensile_strength_after_0_hours: 'Міцність на розрив одразу',
  ...
  friability_after_0_hours: 'Обсиплювальність одразу',
  ...
  // Хімічні/колоїдні
  power_of_hydrogen: 'Водневий показник, pH',
