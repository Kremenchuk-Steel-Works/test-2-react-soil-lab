...
import {
  ironOxideFormSchema,
  type IronOxideFormFields,
} from '@/entities/molding-shop/iron-oxide/ui/IronOxideForm/schema'
...
type FormFields = IronOxideFormFields
const schema = ironOxideFormSchema

export type IronOxideFormOptions = {}
type FormOptions = IronOxideFormOptions

export type IronOxideFormInitialData = FormInitialData<FormFields, FormOptions>

export default function IronOxideForm({
  initialData,
  onSubmit,
  submitBtnName,
