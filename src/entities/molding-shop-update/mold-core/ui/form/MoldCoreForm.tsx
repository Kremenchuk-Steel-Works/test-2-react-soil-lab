...
import { useMoldCoreFormOptions } from '@/entities/molding-shop-update/mold-core/hooks/useMoldCoreFormOptions'
import type { MoldCoreFormFields } from '@/entities/molding-shop-update/mold-core/ui/form/schema'
